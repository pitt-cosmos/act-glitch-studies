...
from routines import TimeSeries, PlotGlitches, Energy,SaveEvents, NPixelStudy, EnergyStudy,CRCorrelationFilter, RaDecStudy
...
loop.add_routine(RaDecStudy(input_key="events", ra_range=[1.2, 1.4], dec_range=[0.08, 0.11],output_key="events"))
